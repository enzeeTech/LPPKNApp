...
const KakitanganForm = React.forwardRef(({ onDataChange, initialData }, ref) => {
    ...
    const validateFieldDynamic = (name, value) => {
        ...
        switch (name) {
            ...
            case 'nama_staff_bertugas':
                if (!value.trim()) {
                    newErrors[name] = "Nama staf diperlukan";
                } else {
                    delete newErrors[name];
                }
                break;
    ...
    const validateFields = () => {
        ...
        // Validate nama staf bertugas
        if (!initialData.nama_staff_bertugas || !initialData.nama_staff_bertugas.trim()) {
            newErrors.nama_staff_bertugas = "Nama staf diperlukan";
            isValid = false;
        }
    ...
    <View style={styles.container}>
        ...
        <View style={styles.inputContainer}>
            ...
            <TextInput
                ...
                style={inputStyle('nama_staff_bertugas')}
                placeholderTextColor={"#A1A1A1"}
            />
            {errors.nama_staff_bertugas && <Text style={styles.errorText}>{errors.nama_staff_bertugas}</Text>}
        </View>
        <View style={styles.inputContainer}>
