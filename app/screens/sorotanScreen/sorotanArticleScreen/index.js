...
import Header from './SorotanArticleHeader';
import InfoSection from './SorotanArticleIBody';
...
const SorotanArticleMain = ({navigation, route}) => {
    ...
    useEffect(() => {
        const fetchItemDetails = async () => {
            try {
                const response = await GlobalApi.getSorotanPostById(itemId);
                setItemDetails({
...
export default SorotanArticleMain;